...
func (s *Service) CreateUser(email, password, firstName, patronymic, lastName string) (entity.ID, error) {
	e, err := entity.NewUser(email, password, firstName, patronymic, lastName)
	if err != nil {
		return e.ID, err
	}
